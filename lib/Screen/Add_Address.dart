...
import 'package:sethStore/Screen/Map.dart';
...
class StateAddress extends State<AddAddress> with TickerProviderStateMixin {
      ...
      child: Container(
        ...
        child: Padding(
            ...
            child: TextFormField(
              ...
              onSaved: (String? value) {},
              decoration: InputDecoration(
                  label: Text(getTranslated(context, 'CITYSELECT_LBL')!),
                  fillColor: Theme.of(context).colorScheme.white,
                  isDense: true,
      ...
      child: Container(
        ...
        child: Padding(
            ...
            child: TextFormField(
              ...
              onSaved: (String? value) {},
              decoration: InputDecoration(
                  label: Text(getTranslated(context, 'AREASELECT_LBL')!),
                  fillColor: Theme.of(context).colorScheme.white,
                  isDense: true,
                  hintText: getTranslated(context, 'AREASELECT_LBL'),
                  border: InputBorder.none),
            )),
      ),
    );
  ...
  Future<void> addNewAddress() async {
    ...
    print(context.read<SettingProvider>().userId);
    print(name);
    print(mobile);
    print(pincodeC!.text);
    print(address);
    ...
    try {
      ...
      data["area"] = areaC!.text;
      data["city"] = cityC!.text;
      apiBaseHelper
          .postAPICall(
